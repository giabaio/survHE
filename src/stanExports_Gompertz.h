...
log_h(const Eigen::Matrix<T0__, Eigen::Dynamic, 1>& t,
    ...
    try {
        ...
        stan::math::assign(log_hvec, add(stan::math::log(rate), multiply(shape, t)));
...
surv_gompertz_lpdf(const Eigen::Matrix<T0__, Eigen::Dynamic, 1>& t,
    ...
    try {
        ...
        stan::math::assign(log_lik, add(elt_multiply(d, log_h(t, shape, rate, pstream__)), log_S(t, shape, rate, pstream__)));
...
class model_Gompertz
  : public stan::model::model_base_crtp<model_Gompertz> {
private:
        int n;
        vector_d t;
        vector_d d;
...
typedef model_Gompertz_namespace::model_Gompertz stan_model;
#ifndef USING_R
