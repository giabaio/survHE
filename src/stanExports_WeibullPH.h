...
log_h(const Eigen::Matrix<T0__, Eigen::Dynamic, 1>& t,
    ...
    try {
        ...
        stan::math::assign(log_hvec, subtract(add(stan::math::log(shape), multiply((shape - 1), stan::math::log(elt_divide(t, scale)))), stan::math::log(scale)));
...
class model_WeibullPH
  : public stan::model::model_base_crtp<model_WeibullPH> {
private:
        int n;
        vector_d t;
        vector_d d;
...
typedef model_WeibullPH_namespace::model_WeibullPH stan_model;
#ifndef USING_R
