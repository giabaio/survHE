...
namespace model_GenGamma2_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_GenGamma2");
    reader.add_event(110, 108, "end", "model_GenGamma2");
    return reader;
}
template <typename T0__, typename T1__, typename T2__, typename T3__>
typename boost::math::tools::promote_args<T0__, T1__, T2__, T3__>::type
gga_ldens(const T0__& x,
              const T1__& alpha,
              const T2__& beta,
              const T3__& nu, std::ostream* pstream__) {
    ...
    try {
        ...
        stan::math::assign(prob, ((((stan::math::log(nu) - stan::math::log(beta)) - stan::math::lgamma((alpha / nu))) + ((alpha - 1) * (stan::math::log(x) - stan::math::log(beta)))) - pow((x / beta), nu)));
...
struct gga_ldens_functor__ {
    template <typename T0__, typename T1__, typename T2__, typename T3__>
        typename boost::math::tools::promote_args<T0__, T1__, T2__, T3__>::type
    operator()(const T0__& x,
              const T1__& alpha,
              const T2__& beta,
              const T3__& nu, std::ostream* pstream__) const {
        return gga_ldens(x, alpha, beta, nu, pstream__);
    }
};
template <typename T0__, typename T1__, typename T2__, typename T3__>
typename boost::math::tools::promote_args<T0__, T1__, T2__, T3__>::type
gga_cumdens(const T0__& x,
                const T1__& alpha,
                const T2__& beta,
                const T3__& nu, std::ostream* pstream__) {
    typedef typename boost::math::tools::promote_args<T0__, T1__, T2__, T3__>::type local_scalar_t__;
    ...
    try {
        ...
        stan::math::assign(prob, gamma_p((alpha / nu), pow((x / beta), nu)));
    ...
    try {
        ...
        for (int i = 1; i <= num_elements(t); ++i) {
            ...
            stan::model::assign(log_lik, 
                        ...
                        ((get_base1(d, i, "d", 1) * (gga_ldens(get_base1(t, i, "t", 1), alpha, get_base1(beta, i, "beta", 1), nu, pstream__) - log1m(gga_cumdens(get_base1(t, i, "t", 1), alpha, get_base1(beta, i, "beta", 1), nu, pstream__)))) + log1m(gga_cumdens(get_base1(t, i, "t", 1), alpha, get_base1(beta, i, "beta", 1), nu, pstream__))), 
...
surv_gen_gamma_lpdf(const Eigen::Matrix<T0__, Eigen::Dynamic, 1>& t,
                        ...
                        const Eigen::Matrix<T3__, Eigen::Dynamic, 1>& beta,
                        const T4__& nu, std::ostream* pstream__) {
    return surv_gen_gamma_lpdf<false>(t,d,alpha,beta,nu, pstream__);
}
struct surv_gen_gamma_lpdf_functor__ {
    ...
    operator()(const Eigen::Matrix<T0__, Eigen::Dynamic, 1>& t,
        ...
        return surv_gen_gamma_lpdf(t, d, alpha, beta, nu, pstream__);
    }
};
#include <stan_meta_header.hpp>
class model_GenGamma2
  : public stan::model::model_base_crtp<model_GenGamma2> {
private:
        int n;
        vector_d t;
        vector_d d;
        ...
        double b_alpha;
public:
    model_GenGamma2(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_GenGamma2_namespace::model_GenGamma2";
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            validate_non_negative_index("exp_linpred", "n", n);
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> exp_linpred(n);
            stan::math::initialize(exp_linpred, DUMMY_VAR__);
            stan::math::fill(exp_linpred, DUMMY_VAR__);
            ...
            for (int i = 1; i <= n; ++i) {
                ...
                stan::model::assign(exp_linpred, 
                            stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                            stan::math::exp(get_base1(linpred, i, "linpred", 1)), 
                            "assigning variable exp_linpred");
            }
            ...
            current_statement_begin__ = 84;
            size_t exp_linpred_j_1_max__ = n;
            for (size_t j_1__ = 0; j_1__ < exp_linpred_j_1_max__; ++j_1__) {
                if (stan::math::is_uninitialized(exp_linpred(j_1__))) {
                    std::stringstream msg__;
                    msg__ << "Undefined transformed parameter: exp_linpred" << "(" << j_1__ << ")";
                    stan::lang::rethrow_located(std::runtime_error(std::string("Error initializing variable exp_linpred: ") + msg__.str()), current_statement_begin__, prog_reader__());
                }
            }
            // model body
            ...
            lp_accum__.add(surv_gen_gamma_lpdf<propto__>(t, d, alpha, exp_linpred, nu, pstream__));
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
            throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_GenGamma2_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        try {
            ...
            current_statement_begin__ = 84;
            validate_non_negative_index("exp_linpred", "n", n);
            Eigen::Matrix<double, Eigen::Dynamic, 1> exp_linpred(n);
            stan::math::initialize(exp_linpred, DUMMY_VAR__);
            stan::math::fill(exp_linpred, DUMMY_VAR__);
            ...
            if (include_tparams__) {
                ...
                size_t exp_linpred_j_1_max__ = n;
                for (size_t j_1__ = 0; j_1__ < exp_linpred_j_1_max__; ++j_1__) {
                    vars__.push_back(exp_linpred(j_1__));
                }
            }
            ...
            stan::math::assign(sigma, pow((nu * alpha), -(0.5)));
            current_statement_begin__ = 106;
            stan::math::assign(Q, pow((nu / alpha), 0.5));
            current_statement_begin__ = 107;
            stan::math::assign(mu, (get_base1(beta, 1, "beta", 1) + ((stan::math::log(alpha) - stan::math::log(nu)) / nu)));
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        if (include_tparams__) {
            ...
            for (size_t j_1__ = 0; j_1__ < exp_linpred_j_1_max__; ++j_1__) {
                param_name_stream__.str(std::string());
                param_name_stream__ << "exp_linpred" << '.' << j_1__ + 1;
                param_names__.push_back(param_name_stream__.str());
            }
        }
        if (!include_gqs__) return;
...
typedef model_GenGamma2_namespace::model_GenGamma2 stan_model;
#ifndef USING_R
