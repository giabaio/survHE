...
namespace model_Gamma2_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_Gamma2");
    reader.add_event(55, 53, "end", "model_Gamma2");
    return reader;
}
template <bool propto, typename T0__, typename T1__, typename T2__, typename T3__>
typename boost::math::tools::promote_args<T0__, T1__, T2__, T3__>::type
surv_gamma_lpdf(const Eigen::Matrix<T0__, Eigen::Dynamic, 1>& t,
                    const Eigen::Matrix<T1__, Eigen::Dynamic, 1>& d,
                    const T2__& shape,
                    const Eigen::Matrix<T3__, Eigen::Dynamic, 1>& rate, std::ostream* pstream__) {
    ...
    try {
        ...
        for (int i = 1; i <= num_elements(t); ++i) {
            ...
            stan::model::assign(log_lik, 
                        ...
                        ((get_base1(d, i, "d", 1) * (gamma_log(get_base1(t, i, "t", 1), shape, get_base1(rate, i, "rate", 1)) - gamma_ccdf_log(get_base1(t, i, "t", 1), shape, get_base1(rate, i, "rate", 1)))) + gamma_ccdf_log(get_base1(t, i, "t", 1), shape, get_base1(rate, i, "rate", 1))), 
...
surv_gamma_lpdf(const Eigen::Matrix<T0__, Eigen::Dynamic, 1>& t,
                    ...
                    const T2__& shape,
                    const Eigen::Matrix<T3__, Eigen::Dynamic, 1>& rate, std::ostream* pstream__) {
    return surv_gamma_lpdf<false>(t,d,shape,rate, pstream__);
}
struct surv_gamma_lpdf_functor__ {
    template <bool propto, typename T0__, typename T1__, typename T2__, typename T3__>
        typename boost::math::tools::promote_args<T0__, T1__, T2__, T3__>::type
    operator()(const Eigen::Matrix<T0__, Eigen::Dynamic, 1>& t,
                    const Eigen::Matrix<T1__, Eigen::Dynamic, 1>& d,
                    const T2__& shape,
                    const Eigen::Matrix<T3__, Eigen::Dynamic, 1>& rate, std::ostream* pstream__) const {
        return surv_gamma_lpdf(t, d, shape, rate, pstream__);
    }
};
#include <stan_meta_header.hpp>
class model_Gamma2
  : public stan::model::model_base_crtp<model_Gamma2> {
private:
        int n;
        vector_d t;
        vector_d d;
        ...
        double b_alpha;
public:
    model_Gamma2(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_Gamma2_namespace::model_Gamma2";
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add(surv_gamma_lpdf<propto__>(t, d, alpha, mu, pstream__));
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
            throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_Gamma2_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_Gamma2_namespace::model_Gamma2 stan_model;
#ifndef USING_R
